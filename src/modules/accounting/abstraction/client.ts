...
abstract class Client<T extends AxiosState> {
  ...
  protected sharedPut(params: EndpointParams & { body: object }) {
    return this.axiosClient
      .put({ endpoint: params.endpoint })
      .setBody(params.body);
  }

  protected sharedPost(params: EndpointParams & { body: object | FormData }) {
    return this.axiosClient
      .post({ endpoint: params.endpoint })
      .setBody(params.body);
  }
...
export { Client as AccountingClient };
