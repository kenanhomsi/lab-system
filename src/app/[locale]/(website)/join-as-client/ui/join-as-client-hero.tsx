...
const HERO_IMG =
  "https://images.unsplash.com/photo-1582719478250-c89cae4dc85f?auto=format&fit=crop&w=2000&q=80";

/**
 * Join-as-client page hero with partnership messaging and CTAs.
 */
export async function JoinAsClientHeroSection() {
  const t = await getTranslations("joinAsClient.hero");

  const highlights = [
    { icon: "handshake", key: "highlight1" },
    { icon: "biotech", key: "highlight2" },
  ...
  return (
    <section className="relative isolate overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute -end-32 top-0 h-[480px] w-[480px] rounded-full bg-secondary/[0.08] blur-[80px]" />
      ...
      <div className="relative z-10 content-container w-full py-16 md:py-24 lg:py-28">
        <div className="max-w-3xl">
          ...
          >
            <Icon name="handshake" filled size="sm" className="text-primary" />
