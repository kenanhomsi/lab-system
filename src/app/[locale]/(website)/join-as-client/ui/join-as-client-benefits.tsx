...
/**
 * Partnership benefits strip for join-as-client page.
 */
export async function JoinAsClientBenefitsSection() {
  const t = await getTranslations("joinAsClient.benefits");
