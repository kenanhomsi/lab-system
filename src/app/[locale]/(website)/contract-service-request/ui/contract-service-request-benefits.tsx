...
/**
 * Benefits of contractual lab services for groups and institutions.
 */
export async function ContractServiceRequestBenefitsSection() {
  const t = await getTranslations("contractServiceRequest.benefits");
