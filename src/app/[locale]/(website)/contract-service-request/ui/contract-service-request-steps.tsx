...
const STEP_ICONS = ["edit_note", "fact_check", "contract"] as const;

/**
 * Three-step overview for contractual service requests.
 */
export async function ContractServiceRequestStepsSection() {
  const t = await getTranslations("contractServiceRequest.steps");
