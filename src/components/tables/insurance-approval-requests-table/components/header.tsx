...
import { IconFilter, IconSearch, IconShield } from "@tabler/icons-react";
...
const InsuranceApprovalHeader = ({
  ...
  const statusOptions = [
    ...
    ...INSURANCE_APPROVAL_STATUSES.map((status) => ({
      value: status,
  ...
  return (
    ...
    >
      ...
      <Select
        ...
        value={statusFilter}
        onChange={(v) => setStatusFilter((v as "all" | InsuranceApprovalStatus) || "all")}
...
export { InsuranceApprovalHeader };
