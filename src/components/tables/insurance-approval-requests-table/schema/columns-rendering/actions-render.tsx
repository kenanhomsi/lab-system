...
const ActionsRender = ({ row }: Props) => {
  ...
  return (
    <Menu shadow="lg" width={220} radius="md" position="bottom-end" offset={8} withArrow trigger="click">
      <Menu.Target>
        <ActionIcon
          variant="subtle"
          color="gray"
      ...
      <Menu.Dropdown>
        <Menu.Item onClick={() => setStatusUpdateTargetId(row.id)}>{t("updateStatus")}</Menu.Item>
