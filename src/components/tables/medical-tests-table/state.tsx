...
const State = ({ children }: { children: React.ReactNode }) => {
  ...
  const [selectedMedicalTest, setSelectedMedicalTest] = useState<MedicalTestItem | null>(null);
  ...
  useMirrorRegistry("selectedMedicalTest", selectedMedicalTest);
  useMirrorRegistry("setSelectedMedicalTest", setSelectedMedicalTest);
