...
import type { ContractServiceRequestItem, ContractServiceRequestStatus } from "./types";
...
const State = ({ children }: PropsWithChildren) => {
  ...
  const [statusFilter, setStatusFilter] = useState<"all" | ContractServiceRequestStatus>("all");
  const [selectedRequest, setSelectedRequest] = useState<ContractServiceRequestItem | null>(null);
